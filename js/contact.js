...
async function justGetData() {
	const url = gurl;
	const key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNvYWRhcHJzeG9mcWt3eHFqcW9yIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM0MTIwOTUsImV4cCI6MjA3ODk4ODA5NX0.dtGwWbjU_WDp3FmczkzlsDzWn6btriiYWWRvGfBVXjk";
	try {
		const response = await fetch(url, {
			"headers": {
				"apikey": key,
				"Auhorization": "Bearer " + key,
